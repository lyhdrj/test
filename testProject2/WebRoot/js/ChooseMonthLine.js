...
function fPopCalendar1(popCtrl){
  ...
  gdCtrl1 = popCtrl;
  var tempVar=popCtrl.value;
  if(tempVar!=undefined&&tempVar!="") {
  	giYear=tempVar.split("-")[0];
  	giMonth=tempVar.split("-")[1];
  }
...
function fToggleTags1(){
  with (document.all.tags("SELECT")){
 	for (i=0; i<length; i++)
 		if ((item(i).Victor!="Won")&&fTagInBound1(item(i))){
