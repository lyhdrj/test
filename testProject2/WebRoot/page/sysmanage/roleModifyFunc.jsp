...
#content table td {
  ...
  <body onkeydown="KeyDown()" >
					...
					<TR>
						...
						<TD
							...
							vAlign=top align="center">
								<div id="current">
									<span>&nbsp;&nbsp;&nbsp;&nbsp;当前位置：角色管理&raquo;角色修改</span>
								</div>
								<div id="content">
   	 ...
   	 <font color="red"><s:property value="#request.hintMsg"/></font>
				...
				<td width="80%">
						 <s:form action="roleManage!modifyOneRole" onsubmit="return onCheck();" namespace="/page/sysmanage">
								<table cellspacing="0" id="mytable">
												...
												<td>角色名称</td>
												<td>
												<input type="text" class="textBox1" name="roleBean.roleName" id="roleName" value="${roleBean.roleName}" maxlength="10"/>
